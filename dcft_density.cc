...
//                               ID("[O,o]"), ID("[O,o]"), 0, "Gamma <Oo|Oo>");
//        global_dpd_->buf4_copy(&Gaa, PSIF_DCFT_DENSITY, "Gamma <OO|OO>");
//        global_dpd_->buf4_close(&Gaa);
//        global_dpd_->buf4_init(&Gaa, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[O,o]"),
//                               ID("[O,o]"), ID("[O,o]"), 0, "Gamma <OO|OO>");
//        global_dpd_->buf4_sort(&Gaa, PSIF_DCFT_DENSITY, qprs, ID("[O,o]"), ID("[O,o]"), "Gamma(temp)");
//        global_dpd_->buf4_close(&Gaa);
//        global_dpd_->buf4_init(&Gaa, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[O,o]"),
//                               ID("[O,o]"), ID("[O,o]"), 0, "Gamma <OO|OO>");
//        global_dpd_->buf4_init(&T, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[O,o]"),
//                               ID("[O,o]"), ID("[O,o]"), 0, "Gamma(temp)");
//        dpd_buf4_add(&Gaa, &T, -1.0);
//        global_dpd_->buf4_close(&Gaa);
//        global_dpd_->buf4_close(&T);

        // Copy Alpha-Alpha case to Beta-Beta case
//        global_dpd_->buf4_init(&Gaa, PSIF_DCFT_DENSITY, 0, ID("[O,O]"), ID("[O,O]"),
//                               ID("[O,O]"), ID("[O,O]"), 0, "Gamma <OO|OO>");
//        global_dpd_->buf4_copy(&Gaa, PSIF_DCFT_DENSITY, "Gamma <oo|oo>");
//        global_dpd_->buf4_close(&Gaa);
...
//        global_dpd_->buf4_copy(&Lab, PSIF_DCFT_DENSITY, "Gamma <Oo|Vv>");
        global_dpd_->buf4_copy(&Lab, PSIF_DCFT_DENSITY, "Gamma SF <OO|VV>");
//        global_dpd_->buf4_sort(&Lab, PSIF_DCFT_DENSITY, rspq, ID("[V,v]"), ID("[O,o]"), "Gamma <Vv|Oo>");
        global_dpd_->buf4_sort(&Lab, PSIF_DCFT_DENSITY, rspq, ID("[V,V]"), ID("[O,O]"), "Gamma SF <VV|OO>");
        global_dpd_->buf4_close(&Lab);
...
//        global_dpd_->buf4_init(&Gaa, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[V,v]"),
//                               ID("[O,o]"), ID("[V,v]"), 0, "Gamma <OO|VV>");
//        global_dpd_->buf4_sort(&Gaa, PSIF_DCFT_DENSITY, qprs, ID("[O,o]"), ID("[V,v]"), "Gamma(temp2)");
//        global_dpd_->buf4_close(&Gaa);
//        global_dpd_->buf4_init(&Gaa, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[V,v]"),
//                               ID("[O,o]"), ID("[V,v]"), 0, "Gamma <OO|VV>");
//        global_dpd_->buf4_init(&T, PSIF_DCFT_DENSITY, 0, ID("[O,o]"), ID("[V,v]"),
//                               ID("[O,o]"), ID("[V,v]"), 0, "Gamma(temp2)");
//        dpd_buf4_add(&Gaa, &T, -1.0);
//        global_dpd_->buf4_close(&Gaa);
//        global_dpd_->buf4_close(&T);
...
//                               ID("[V,V]"), ID("[O,O]"), 0, "Gamma <VV|OO>");
//        global_dpd_->buf4_copy(&Gaa, PSIF_DCFT_DENSITY, "Gamma <vv|oo>");
//        global_dpd_->buf4_close(&Gaa);
...
//        global_dpd_->buf4_sort(&Tab, PSIF_DCFT_DENSITY, psrq, ID("[O,v]"), ID("[o,V]"), "Gamma <Ov|oV>");
        global_dpd_->buf4_sort(&Tab, PSIF_DCFT_DENSITY, psrq, ID("[O,V]"), ID("[O,V]"), "Gamma SF <OV|OV>:<Ov|oV>");
...
//        global_dpd_->buf4_init(&LLaa, PSIF_DCFT_DPD, 0, ID("[O,V]"), ID("[O,V]"),
//                      ID("[O,V]"), ID("[O,V]"), 0, "Lambda (OV|OV)");
//        global_dpd_->contract444(&Laa, &LLaa, &Gbb, 0, 0, -1.0, 0.0);
//        global_dpd_->buf4_close(&Laa);
//        global_dpd_->buf4_close(&LLaa);
////        global_dpd_->buf4_init(&Lab, PSIF_DCFT_DPD, 0, ID("[O,V]"), ID("[o,v]"),
////                      ID("[O,V]"), ID("[o,v]"), 0, "Lambda (OV|ov)");
